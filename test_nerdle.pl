...
test(384, Ps == ["2-7+14=9","2-8+10=4","2-9+14=7","2-8+14=8","2-9+11=4"]) :-
    puzzle_solve_all(["2*4+5=13"-gbrgbrrb],
                     "2-7+14=9",
                     Ps).

test(385, Ps == ["6*8-5=43","8*6-5=43"]) :-
    puzzle_solve_all(["2*4+5=13"-bgrbggbg],
                     "6*8-5=43",
                     Ps).

test(386, Ps == ["2/10*5=1","2/5*15=6","2/6*15=5","21-2*8=5","21-8*2=5","26-5*5=1","25*6=150","25*1/5=5","25/5*1=5","20*5=100","21*5=105","25*7=175","26*6=156","25*5=125"]) :-
    puzzle_solve_all(["2*4+5=13"-grbbrrrb],
                     "25/5*1=5",
                     Ps).

test(387, Ps == ["84/7-9=3","40/4-7=3","48/4-9=3","49/7-4=3","63/9-4=3","96/4/8=3","96/8/4=3","36/4-6=3","44/4-8=3","48/8-3=3","84/4/7=3","84/7/4=3","36/3/4=3","36/4/3=3","48/4/4=3"]) :-
    puzzle_solve_all(["2*4+5=13"-bbrbbrbg],
                     "63/9-4=3",
                     Ps).

test(388, Ps == ["3-8+14=9","3-9+10=4","3-9+14=8","4-8+13=9","4-9+13=8"]) :-
    puzzle_solve_all(["2*4+5=13"-bbrgbrrr],
                     "3-9+14=8",
                     Ps).

test(389, Ps == ["69*4=276","92*7=644","42*7=294"]) :-
    puzzle_solve_all(["2*4+5=13"-rrrbbrbb,
                      "74-8*9=2"-rrbbrrrr],
                     "69*4=276",
                     Ps).

test(390, Ps == ["3*8/1=24","4*6-3=21","4*8/1=32","8*3/1=24","1*3*8=24","1*8*3=24","1*8*4=32","3*1*8=24","3*8*1=24","4*1*8=32","4*8*1=32","8*1*3=24","8*1*4=32","8*3*1=24"]) :-
    puzzle_solve_all(["2*4+5=13"-rgrbbgrr],
                     "1*3*8=24",
                     Ps).

test(391, Ps == ["3*7+5=26","3*8+5=29","7*3+5=26","8*3+5=29","3*5+5=20","3*9+5=32","5*3+5=20","9*3+5=32"]) :-
    puzzle_solve_all(["2*4+5=13"-rgbgggbr],
                     "3*8+5=29",
                     Ps).
test(391, Ps == ["3*8+5=29","3*5+5=20"]) :-
    puzzle_solve_all(["2*4+5=13"-rgbgggbr,
                      "3*7+5=26"-ggbggggb],
                     "3*8+5=29",
                     Ps).

test(392, Ps == ["304/76=4","384/96=4","744/93=8","304/38=8","344/86=4","384/64=6","664/83=8","344/43=8","384/48=8"]) :-
    puzzle_solve_all(["2*4+5=13"-bbgbbrbr],
                     "744/93=8",
                     Ps).

test(393, Ps == ["1+7+4=12","6+6+2=14","7+1+4=12"]) :-
    puzzle_solve_all(["2*4+5=13"-rbrgbggb,
                      "4-2+8=10"-rbrgbggb],
                     "6+6+2=14",
                     Ps).

test(394, Ps == ["3+6*8=51","3+8*6=51"]) :-
    puzzle_solve_all(["2*4+5=13"-brbrrgrr,
                      "1+5*7=36"-rgrgbgrr],
                     "3+6*8=51",
                     Ps).
test(394, Ps == ["1+5*7=36","3+6*8=51","3+8*6=51","1+5*6=31"]) :-
    puzzle_solve_all(["2*4+5=13"-brbrrgrr],
                     "3+6*8=51",
                     Ps).

test(395, Ps == ["38-13=25","52-17=35"]) :-
    puzzle_solve_all(["2*4+5=13"-rbbbrgrr,
                      "130/2=65"-rrbbrgbg],
                     "38-13=25",
                     Ps).

test(396, Ps == ["4+4*9=40","8+4*8=40","8+4*9=44"]) :-
    puzzle_solve_all(["2*4+5=13"-brgrbgbb],
                     "8+4*8=40",
                     Ps).

test(397, Ps == ["5*7+8=43","7*5+8=43","5*8+3=43","7*7+4=53","8*5+3=43"]) :-
...
test(398, Ps == ["54*1/6=9","54*1/9=6","54/6*1=9","54/9*1=6","45*1/5=9","45*1/9=5","45/5*1=9","45/9*1=5"]) :-
